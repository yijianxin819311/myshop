    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a class="J_menuItem" href="{{url('admins/index')}}">
                ...
                <li>
                    <a href="#">
                        ...
                        <span class="nav-label">登录注册</span>
                        <span class="fa arrow"></span>
                    </a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="{{url('admins/login')}}">登录</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('admins/register')}}">注册</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="{{url('admins/cate')}}">商品分类添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('admins/lists')}}">商品分类展示</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('admins/goods_type')}}">商品类型添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('admins/type_list')}}">商品类型展示</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('admins/goods_attr')}}">商品属性添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('admins/attr_list')}}">商品属性展示</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('admins/goods')}}">商品添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('admins/goods_list')}}">商品展示</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{url('admins/goods_sku/goods_id')}}">货品添加</a>
                        </li>
                    </ul>
                </li>
                <li class="line dk"></li>
